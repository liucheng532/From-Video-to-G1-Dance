...
from robocup_lab.assets import ASSET_DIR
from robocup_lab.robots.actuator import DelayedImplicitActuatorCfg
...
BOOSTER_T1_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{ASSET_DIR}/booster_t1/urdf/main.urdf",
...
for a in BOOSTER_T1_CFG.actuators.values():
    ...
    for n in names:
        if n in e and n in s and s[n]:
            BOOSTER_T1_ACTION_SCALE[n] = 0.25 * e[n] / s[n]
